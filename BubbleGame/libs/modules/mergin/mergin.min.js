...
var app;!function(t){var e=function(){function e(){this._eventMap={}}var n=(__define,e),r=n.prototype;return e.create=function(){var e=new t.EventDispatcher;return e},r.on=function(t,e,n){this.addEventListener(t,e,n)},r.off=function(t,e,n){this.removeEventListener(t,e,n)},r.has=function(t,e,n){this.hasEventListener(t,e,n)},r.emit=function(t,e){this.dispatchEvent(t,e)},r.once=function(t,e,n){this.addEventListener(t,e,n,!0)},r.offAll=function(t){t?delete this._eventMap[t]:this._eventMap={}},r.addEventListener=function(t,e,n,r){if(void 0===r&&(r=!1),this.hasEventListener(t,e,n))return console.log("repeat add Event");var i=this._eventMap[t];i||(i=[],this._eventMap[t]=i),i.push({eventID:t,callback:e,thisObj:n,once:r})},r.removeEventListener=function(t,e,n){for(var r=this._eventMap[t],i=r.length,a=0;i>a;a++){var o=r[a];if(o&&o.callback===e&&o.thisObj===n){r.splice(a,1);break}}},r.hasEventListener=function(t,e,n){var r=this._eventMap[t];if(!r)return!1;for(var i=r.length,a=0;i>a;a++){var o=r[a];if(o&&o.callback===e&&o.thisObj===n)return!0}return!1},r.dispatchEvent=function(t,e){var n=this._eventMap[t];if(n)for(var r=n.slice(0),i=r.length,a=0;i>a;a++){var o=r[a];o.once&&n.splice(a,1),o.callback.call(o.thisObj,e)}},e}();t.EventDispatcher=e,egret.registerClass(e,"app.EventDispatcher")}(app||(app={}));var app;!function(t){var e=function(){function t(t,e,n){this.appName=t,this.data=n,this.isSpecialInCloseAll=e}var e=(__define,t);return e.prototype,t}();t.AppInfo=e,egret.registerClass(e,"app.AppInfo")}(app||(app={}));var app;!function(t){var e=function(){function e(){this._appNameDictionary={}}var n=(__define,e),r=n.prototype;return e.create=function(){return new t.AppRegister},r.registerAppInfo=function(e,n,r){var i=this._appNameDictionary[e];return i||(i=new t.AppInfo(e,n,r),this._appNameDictionary[e]=i),e},r.getAppInfoByAppName=function(t){return this._appNameDictionary[t]},r.getPanelNameByAppName=function(t){var e=this._appNameDictionary[t];return e?e.panelName:""},e}();t.AppRegister=e,egret.registerClass(e,"app.AppRegister")}(app||(app={}));var app;!function(t){var e=function(){function e(t){this.state=0,this._appInfo=t}var n=__define,r=e,i=r.prototype;return i.init=function(t,e){this._data=t,this._parentContainer=e},i.setup=function(){this.initAndShowApp(this._appInfo.appName)},i.show=function(){if(this._iapp){var t=Date.now();this._iapp.addEvent(),this.state=2,this._iapp.show(this._parentContainer),this._iapp.refresh(this._data);var e=Date.now();console.log(this._appInfo.appName,"##打开用时##",e-t)}},i.refresh=function(t){if(this._data=t,this._iapp){var e=Date.now();this._iapp.refresh(this._data);var n=Date.now();console.log(this._appInfo.appName,"##刷新用时##",n-e)}},i.initAndShowApp=function(e){if(this._iapp)this.show();else{var n=Date.now(),r=t.getDefinitionByName(e);if(r){this._iapp=new r,this._iapp.appInfo=this._appInfo,this._iapp.init();var i=Date.now();console.log(this._appInfo.appName,"##初始化用时##",i-n),3!=this.state&&this.show()}else console.log(this._appInfo.appName,"##打开失败，未找到##")}},i.hide=function(){var t=Date.now();this._iapp&&this.isShowing&&(this._iapp.removeEvent(),this._iapp.hide()),this._data=this._parentContainer=null;var e=Date.now();this.isShowing&&console.log(this._appInfo.appName,"##关闭用时##",e-t),this.state=3},i.dispose=function(){this.hide();var t=Date.now();this._iapp&&this._iapp.dispose();var e=Date.now();console.log(this._appInfo.appName,"##释放用时##",e-t)},n(i,"appInfo",function(){return this._appInfo}),n(i,"isShowing",function(){return 2==this.state}),i.ready=function(){this.state=1},i.isReady=function(){return 1==this.state},e}();t.AppPanel=e,egret.registerClass(e,"app.AppPanel")}(app||(app={}));var app;!function(t){var e=function(){function t(t){this._panelDictionary={},this._app=t}var e=(__define,t),n=e.prototype;return t.create=function(e){return new t(e)},n.showApp=function(t,e,n){void 0===e&&(e=null),void 0===n&&(n=null);var r=this._app.appRegister.getAppInfoByAppName(t);r&&this.turnApp(r,e,n)},n.refreshApp=function(t,e){void 0===e&&(e=null);var n=this._app.appRegister.getAppInfoByAppName(t);if(n){var r=this._panelDictionary[n.appName];r&&r.isShowing&&r.refresh(e)}},n.hideApp=function(t){var e=this._panelDictionary[t];e&&e.hide(),e&&this._app.after.emit(function(){},e.appInfo)},n.dispose=function(t){var e=this._panelDictionary[t];if(e&&e.hide(),e){var n=this;this._app.after.emit(function(){e.dispose(),e=null,delete n._panelDictionary[t]},e.appInfo)}},n.turnApp=function(t,e,n){if(t){var r=this._panelDictionary[t.appName];r||(r=new app.AppPanel(t),this._panelDictionary[t.appName]=r),r.isShowing?r.hide():r.isReady()?r.hide():(r.ready(),this._app.before.emit(function(){r.init(e,n),r.setup()},t))}},n.closeAllApp=function(){for(var t in this._panelDictionary){var e=this._panelDictionary[t];e&&0==e.appInfo.isSpecialInCloseAll&&e.hide()}},n.isAppShowing=function(t){var e=this._panelDictionary[t];return!(!e||!e.isShowing)},t}();t.AppManager=e,egret.registerClass(e,"app.AppManager")}(app||(app={}));var app;!function(t){var e=function(){function t(){this._uselist=[]}var e=(__define,t),n=e.prototype;return t.create=function(){return new t},n.clear=function(){return this._uselist.length=0,this},n.use=function(t){if("function"==typeof t){if(t.length<1)throw"参数长度不少于一位！"}else{if(!t.route||"function"!=typeof t.route)throw"不存在route函数";if(t.route.length<1)throw"参数长度不少于一位！"}return this._uselist.push(t),this},n["catch"]=function(t){if(!t||"function"!=typeof t||t.length<1)throw"错误函数不存在或不是函数或参数个数少于一位";return this._error=t,this},n.emit=function(t){function e(){for(var n=[],r=0;r<arguments.length;r++)n[r-0]=arguments[r];if(n.length>0){var o=n.shift();if(o)return a?a(o):console.log("Route ERROR==>",o)}if(0==i.length)return t&&t();var s=i.shift();n.unshift(e),"function"==typeof s?s.apply(null,n):s.route.apply(s,n)}for(var n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r];if(t&&"function"!=typeof t)throw"完成函数不存在或不是函数";var i=this._uselist.concat(),a=this._error;n.unshift(null),e.apply(null,n)},t}();t.Route=e,egret.registerClass(e,"app.Route")}(app||(app={}));var app;!function(t){function e(t){if(!t)return null;var e=n[t];if(e)return e;var r=t.split("."),i=r.length;e=window;for(var a=0;i>a;a++){var o=r[a];if(e=e[o],!e)return null}return n[t]=e,e}var n={};t.getDefinitionByName=e;var r=function(){function e(){}var n=(__define,e),r=n.prototype;return e.create=function(){var e=new t.App;return e.eventproxy=t.EventDispatcher.create(),e.appRegister=t.AppRegister.create(),e.appManager=t.AppManager.create(e),e.before=t.Route.create(),e.after=t.Route.create(),e},r.showApp=function(t,e,n){this.appManager.showApp(t,e,n)},r.refreshApp=function(t,e){this.appManager.refreshApp(t,e)},r.hideApp=function(t){this.appManager.hideApp(t)},r.dispose=function(t){this.appManager.dispose(t)},r.closeAllApp=function(){this.appManager.closeAllApp()},r.isAppShowing=function(t){return this.appManager.isAppShowing(t)},r.registerAppInfo=function(t,e,n){return this.appRegister.registerAppInfo(t,e,n)},r.getAppInfoByAppName=function(t){return this.appRegister.getAppInfoByAppName(t)},r.getPanelNameByAppName=function(t){return this.appRegister.getPanelNameByAppName(t)},e.getDefinitionByNameCache={},e}();t.App=r,egret.registerClass(r,"app.App")}(app||(app={}));var rm;if("undefined"==typeof window){var DOMParser=require("xmldom").DOMParser,window={};window.DOMParser=!0}!function(t){t.ObjTree=function(){return this},t.ObjTree.VERSION="0.24",t.ObjTree.prototype.xmlDecl='<?xml version="1.0" encoding="UTF-8" ?>\n',t.ObjTree.prototype.attr_prefix="-",t.ObjTree.prototype.overrideMimeType="text/xml",t.ObjTree.prototype.parseXML=function(t){var e;if(window.DOMParser){var n=new DOMParser,r=n.parseFromString(t,"application/xml");if(!r)return;e=r.documentElement}else window.ActiveXObject&&(n=new ActiveXObject("Microsoft.XMLDOM"),n.async=!1,n.loadXML(t),e=n.documentElement);if(e)return this.parseDOM(e)},t.ObjTree.prototype.parseHTTP=function(t,e,n){var r={};for(var i in e)r[i]=e[i];if(r.method||("undefined"==typeof r.postBody&&"undefined"==typeof r.postbody&&"undefined"==typeof r.parameters?r.method="get":r.method="post"),n){r.asynchronous=!0;var a=this,o=n,s=r.onComplete;r.onComplete=function(t){var e;t&&t.responseXML&&t.responseXML.documentElement?e=a.parseDOM(t.responseXML.documentElement):t&&t.responseText&&(e=a.parseXML(t.responseText)),o(e,t),s&&s(t)}}else r.asynchronous=!1;var p;if("undefined"!=typeof HTTP&&HTTP.Request){r.uri=t;var u=new HTTP.Request(r);u&&(p=u.transport)}else if("undefined"!=typeof Ajax&&Ajax.Request){var u=new Ajax.Request(t,r);u&&(p=u.transport)}return n?p:p&&p.responseXML&&p.responseXML.documentElement?this.parseDOM(p.responseXML.documentElement):p&&p.responseText?this.parseXML(p.responseText):void 0},t.ObjTree.prototype.parseDOM=function(t){if(t){if(this.__force_array={},this.force_array)for(var e=0;e<this.force_array.length;e++)this.__force_array[this.force_array[e]]=1;var n=this.parseElement(t);if(this.__force_array[t.nodeName]&&(n=[n]),11!=t.nodeType){var r={};r[t.nodeName]=n,n=r}if(this.soft_arrays){var i=function(t){if("string"!=typeof t){for(var e in t)i(t[e]);t.length||(t.length=1,t[0]=t)}};i(n)}return n}},t.ObjTree.prototype.parseElement=function(t){if(7!=t.nodeType){if(3==t.nodeType||4==t.nodeType){var e=t.nodeValue.match(/[^\x00-\x20]/);if(null==e)return;return t.nodeValue}var n,r={};if(t.attributes&&t.attributes.length){n={};for(var i=0;i<t.attributes.length;i++){var a=t.attributes[i].nodeName;if("string"==typeof a){var o=t.attributes[i].nodeValue;o&&(a=this.attr_prefix+a,"undefined"==typeof r[a]&&(r[a]=0),r[a]++,this.addNode(n,a,r[a],o))}}}if(t.childNodes&&t.childNodes.length){var s=!0;n&&(s=!1);for(var i=0;i<t.childNodes.length&&s;i++){var p=t.childNodes[i].nodeType;3!=p&&4!=p&&(s=!1)}if(s){n||(n="");for(var i=0;i<t.childNodes.length;i++)n+=t.childNodes[i].nodeValue}else{n||(n={});for(var i=0;i<t.childNodes.length;i++){var a=t.childNodes[i].nodeName;if("string"==typeof a){var o=this.parseElement(t.childNodes[i]);o&&("undefined"==typeof r[a]&&(r[a]=0),r[a]++,this.addNode(n,a,r[a],o))}}}}return n}},t.ObjTree.prototype.addNode=function(t,e,n,r){this.__force_array[e]?(1==n&&(t[e]=[]),t[e][t[e].length]=r):1==n?t[e]=r:2==n?t[e]=[t[e],r]:t[e][t[e].length]=r},t.ObjTree.prototype.writeXML=function(t,e){var n=this.hash_to_xml(t,e);return this.xmlDecl+n},t.ObjTree.prototype.hash_to_xml=function(t,e){var n=[],r=[];for(var i in e)if(e.hasOwnProperty(i)){var a=e[i];i.charAt(0)!=this.attr_prefix?"undefined"==typeof a||null==a?n[n.length]="<"+i+" />":"object"==typeof a&&a.constructor==Array?n[n.length]=this.array_to_xml(i,a):"object"==typeof a?n[n.length]=this.hash_to_xml(i,a):n[n.length]=this.scalar_to_xml(i,a):r[r.length]=" "+i.substring(1)+'="'+this.xml_escape(a)+'"'}var o=r.join(""),s=n.join("");return"undefined"==typeof t||null==t||(s=n.length>0?s.match(/\n/)?"<"+t+o+">\n"+s+"</"+t+">\n":"<"+t+o+">"+s+"</"+t+">\n":"<"+t+o+" />\n"),s},t.ObjTree.prototype.array_to_xml=function(t,e){for(var n=[],r=0;r<e.length;r++){var i=e[r];"undefined"==typeof i||null==i?n[n.length]="<"+t+" />":"object"==typeof i&&i.constructor==Array?n[n.length]=this.array_to_xml(t,i):"object"==typeof i?n[n.length]=this.hash_to_xml(t,i):n[n.length]=this.scalar_to_xml(t,i)}return n.join("")},t.ObjTree.prototype.scalar_to_xml=function(t,e){return"#text"==t?this.xml_escape(e):"<"+t+">"+this.xml_escape(e)+"</"+t+">\n"},t.ObjTree.prototype.xml_escape=function(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}}(rm||(rm={}));var rm;!function(t){t.Tween={Linear:function(t,e,n,r){return n*t/r+e},Quad:{easeIn:function(t,e,n,r){return n*(t/=r)*t+e},easeOut:function(t,e,n,r){return-n*(t/=r)*(t-2)+e},easeInOut:function(t,e,n,r){return(t/=r/2)<1?n/2*t*t+e:-n/2*(--t*(t-2)-1)+e}},Cubic:{easeIn:function(t,e,n,r){return n*(t/=r)*t*t+e},easeOut:function(t,e,n,r){return n*((t=t/r-1)*t*t+1)+e},easeInOut:function(t,e,n,r){return(t/=r/2)<1?n/2*t*t*t+e:n/2*((t-=2)*t*t+2)+e}},Quart:{easeIn:function(t,e,n,r){return n*(t/=r)*t*t*t+e},easeOut:function(t,e,n,r){return-n*((t=t/r-1)*t*t*t-1)+e},easeInOut:function(t,e,n,r){return(t/=r/2)<1?n/2*t*t*t*t+e:-n/2*((t-=2)*t*t*t-2)+e}},Quint:{easeIn:function(t,e,n,r){return n*(t/=r)*t*t*t*t+e},easeOut:function(t,e,n,r){return n*((t=t/r-1)*t*t*t*t+1)+e},easeInOut:function(t,e,n,r){return(t/=r/2)<1?n/2*t*t*t*t*t+e:n/2*((t-=2)*t*t*t*t+2)+e}},Sine:{easeIn:function(t,e,n,r){return-n*Math.cos(t/r*(Math.PI/2))+n+e},easeOut:function(t,e,n,r){return n*Math.sin(t/r*(Math.PI/2))+e},easeInOut:function(t,e,n,r){return-n/2*(Math.cos(Math.PI*t/r)-1)+e}},Expo:{easeIn:function(t,e,n,r){return 0==t?e:n*Math.pow(2,10*(t/r-1))+e},easeOut:function(t,e,n,r){return t==r?e+n:n*(-Math.pow(2,-10*t/r)+1)+e},easeInOut:function(t,e,n,r){return 0==t?e:t==r?e+n:(t/=r/2)<1?n/2*Math.pow(2,10*(t-1))+e:n/2*(-Math.pow(2,-10*--t)+2)+e}},Circ:{easeIn:function(t,e,n,r){return-n*(Math.sqrt(1-(t/=r)*t)-1)+e},easeOut:function(t,e,n,r){return n*Math.sqrt(1-(t=t/r-1)*t)+e},easeInOut:function(t,e,n,r){return(t/=r/2)<1?-n/2*(Math.sqrt(1-t*t)-1)+e:n/2*(Math.sqrt(1-(t-=2)*t)+1)+e}},Elastic:{easeIn:function(t,e,n,r,i,a){if(0==t)return e;if(1==(t/=r))return e+n;if(a||(a=.3*r),!i||i<Math.abs(n)){i=n;var o=a/4}else var o=a/(2*Math.PI)*Math.asin(n/i);return-(i*Math.pow(2,10*(t-=1))*Math.sin((t*r-o)*(2*Math.PI)/a))+e},easeOut:function(t,e,n,r,i,a){if(0==t)return e;if(1==(t/=r))return e+n;if(a||(a=.3*r),!i||i<Math.abs(n)){i=n;var o=a/4}else var o=a/(2*Math.PI)*Math.asin(n/i);return i*Math.pow(2,-10*t)*Math.sin((t*r-o)*(2*Math.PI)/a)+n+e},easeInOut:function(t,e,n,r,i,a){if(0==t)return e;if(2==(t/=r/2))return e+n;if(a||(a=r*(.3*1.5)),!i||i<Math.abs(n)){i=n;var o=a/4}else var o=a/(2*Math.PI)*Math.asin(n/i);return 1>t?-.5*(i*Math.pow(2,10*(t-=1))*Math.sin((t*r-o)*(2*Math.PI)/a))+e:i*Math.pow(2,-10*(t-=1))*Math.sin((t*r-o)*(2*Math.PI)/a)*.5+n+e}},Back:{easeIn:function(t,e,n,r,i){return void 0==i&&(i=1.70158),n*(t/=r)*t*((i+1)*t-i)+e},easeOut:function(t,e,n,r,i){return void 0==i&&(i=1.70158),n*((t=t/r-1)*t*((i+1)*t+i)+1)+e},easeInOut:function(t,e,n,r,i){return void 0==i&&(i=1.70158),(t/=r/2)<1?n/2*(t*t*(((i*=1.525)+1)*t-i))+e:n/2*((t-=2)*t*(((i*=1.525)+1)*t+i)+2)+e}},Bounce:{easeIn:function(e,n,r,i){return r-t.Tween.Bounce.easeOut(i-e,0,r,i)+n},easeOut:function(t,e,n,r){return(t/=r)<1/2.75?n*(7.5625*t*t)+e:2/2.75>t?n*(7.5625*(t-=1.5/2.75)*t+.75)+e:2.5/2.75>t?n*(7.5625*(t-=2.25/2.75)*t+.9375)+e:n*(7.5625*(t-=2.625/2.75)*t+.984375)+e},easeInOut:function(e,n,r,i){return i/2>e?.5*t.Tween.Bounce.easeIn(2*e,0,r,i)+n:.5*t.Tween.Bounce.easeOut(2*e-i,0,r,i)+.5*r+n}}}}(rm||(rm={}));var rm;!function(t){function e(){return c++}function n(t){return t*Math.PI/180}function r(t){return t/Math.PI*180}function i(t){(isNaN(t)||0>t)&&(t=0),t>16777215&&(t=16777215);for(var e=t.toString(16).toUpperCase();e.length<6;)e="0"+e;return"#"+e}function a(){for(var t=Math.ceil(16777215*Math.random()).toString(16);t.length<6;)t="0"+t;return"0x"+t}function o(e,n){return t.radian2angle(Math.atan2(n,e))}function s(t,e){return t+Math.random()*(e-t)}function p(t,e,n){void 0===n&&(n=null);var r=t/180*Math.PI,i=new egret.Point(e*Math.cos(r),e*Math.sin(r));return null!=n&&(i.x+=n.x,i.y+=n.y),i}function u(t){var e=[];if(t)for(var n=t.concat();n.length;){var r=n.length*Math.random();e.push(n.splice(r,1)[0])}return e}function h(t,e,n,r,i,a,o,s){void 0===i&&(i=.6),void 0===a&&(a=0),void 0===s&&(s=!1);var o=o||new egret.Point,p=[];s&&p.push(o);for(var u=n,h=t,f=1;r>=f;){for(var c=360/h,l=0;h>l;l++){var v=(c*l+a)/180*Math.PI;point=new egret.Point,point.x=u*Math.cos(v),point.y=u*Math.sin(v)*i,point.offset(o.x,o.y),p.push(point)}h+=e,u+=n,f++}return p}function f(t){return"[object Array]"===Object.prototype.toString.call(t)}var c=0;t.g_next=e,t.angle2radian=n,t.radian2angle=r,t.toColorString=i,t.randomColor=a,t.getAngle=o,t.getRandom=s,t.getCirclePoint=p,t.randomArray=u,t.getPointsInCircle=h,t.isArray=f}(rm||(rm={}));var rm;!function(t){function e(t,e){return n.Levenshtein_Distance_Percent(t,e)}var n=function(){function t(){}var e=(__define,t);e.prototype;return t.Levenshtein_Distance=function(t,e){var n,r,i,a,o,s=t.length,p=e.length,u=[];if(0==s)return p;if(0==p)return s;for(n=0;s>=n;n++)u[n]=[],u[n][0]=n;for(r=0;p>=r;r++)u[0][r]=r;for(n=1;s>=n;n++)for(i=t.charAt(n-1),r=1;p>=r;r++)a=e.charAt(r-1),o=i==a?0:1,u[n][r]=this.Minimum(u[n-1][r]+1,u[n][r-1]+1,u[n-1][r-1]+o);return u[s][p]},t.Levenshtein_Distance_Percent=function(t,e){var n=Math.max(t.length,e.length),r=this.Levenshtein_Distance(t,e);return 1-r/n},t.Minimum=function(t,e,n){return e>t?n>t?t:n:n>e?e:n},t}();egret.registerClass(n,"LevenshteinDistance"),t.Levenshtein_Distance_Percent=e}(rm||(rm={}));var rm;!function(t){function e(){for(var e=[],n=0;n<arguments.length;n++)e[n-0]=arguments[n];t.Log.DEBUG&&(t.Log.EGRET_DEBUG?egret.log(e.toString()):console.log(e.toString()))}t.log=e;var n=function(){function t(){}var e=(__define,t);e.prototype;return t.DEBUG=!1,t.EGRET_DEBUG=!1,t}();t.Log=n,egret.registerClass(n,"rm.Log")}(rm||(rm={}));var rm;!function(t){function e(t,e,i,a,o,s,p){void 0===a&&(a=0),void 0===o&&(o=!0),void 0===s&&(s=null),void 0===p&&(p=2147483647);var u,h,f;if(a>0)return u=t*Math.pow(10,a),h=n(u,i),h>=i.length?t.toString():(u=o?Math.floor(u/i[h]):Math.ceil(u/i[h]),f=(u/Math.pow(10,a)).toFixed(a),-1!=f.indexOf(".0")&&(f=f.substr(0,f.length-2)),f+e[h]);if(h=n(t,i),h>=i.length)return t.toString();var c=i.length,l=0,v="";u=t;for(var g=h;c>g&&p>l;g++,l++){var d;d=l!=p-1&&g!=c-1||o?Math.ceil(u/i[g]>>0):Math.ceil(u/i[g]),v+=null==s?d.toString():r(d,s[g]),v+=e[g],u%=i[g]}return v}function n(t,e){for(var n=e.length,r=0;n>r&&!(e[r]<=t);r++);return r}function r(t,e){for(var n=t.toString(),r="",i=n.length;e>i;i++)r+="0";return r+n}t.numberFormat=e,t.getUnit=n,t.fixLen=r}(rm||(rm={}));var rm;!function(t){var e=function(){function e(){}var n=(__define,e);n.prototype;return e.getPool=function(t){var e=this.CLASSLIST[t];return e||(this.CLASSLIST[t]=[],e=this.CLASSLIST[t]),e},e.getClass=function(e){var n=this.getPool(e);if(n.length>0)return n.shift();var r=egret.getDefinitionByName(e);return r?new r:(t.log(e,"##实例化失败，类不存在##"),null)},e.release=function(t){t.reset();var e=egret.getQualifiedClassName(t),n=this.getPool(e);n.push(t)},e.getClassLength=function(t){return this.CLASSLIST[t]?this.CLASSLIST[t].length:0},e.CLASSLIST={},e}();t.PoolUtil=e,egret.registerClass(e,"rm.PoolUtil")}(rm||(rm={}));var rm;!function(t){var e=function(){function t(){}var e=__define,n=t;n.prototype;return t.start=function(t){return void 0===t&&(t=0),this._count=t,this._count},e(t,"next",function(){return++this._count}),t._count=0,t}();t.RNumber=e,egret.registerClass(e,"rm.RNumber")}(rm||(rm={}));var rm;!function(t){var e=function(){function e(){this.x=0,this.y=0}var n=(__define,e),r=n.prototype;return e.create=function(e,n){void 0===e&&(e=0),void 0===n&&(n=0);var r=new t.Vector2D;return r.resetToValue(e,n),r},r.reset=function(){this.x=this.y=0},r.clone=function(){return t.Vector2D.create(this.x,this.y)},r.resetToValue=function(t,e){return this.x=t,this.y=e,this},r.resetToPoint=function(t){return this.x=t.x,this.y=t.y,this},r.add=function(t){return this.x+=t.x,this.y+=t.y,this},r.sub=function(t){return this.x-=t.x,this.y-=t.y,this},r.mul=function(t){return this.x*=t,this.y*=t,this},r.div=function(t){return this.x/=t,this.y/=t,this},r.equals=function(t){return this.x==t.x&&this.y==t.y},r.distance=function(t){return this.clone().sub(t).lenght()},r.lenght=function(){return Math.sqrt(this.x*this.x+this.y*this.y)},r.isZero=function(){return 0==this.x&&0==this.y},r.negate=function(){return this.mul(-1),this},r.rotate=function(e,n){var r=t.angle2radian(n%360),i=Math.sin(r),a=Math.cos(r);if(e.isZero()){var o=this.x*a-this.y*i;this.y=this.y*a+this.x*i,this.x=o}else{var o=this.x-e.x,s=this.y-e.y;this.x=o*a-s*i+e.x,this.y=s*a+o*i+e.y}return this},r.clamp=function(t,e){return e.x>t.x||e.y>t.y?(console.log(this.toString()),this):(this.x<e.x&&(this.x=e.x),this.x>t.x&&(this.x=t.x),this.y<e.y&&(this.y=e.y),this.y>t.y&&(this.y=t.y),this)},r.pMidpoint=function(t){return this.clone().add(t).div(2)},r.toString=function(){return"(x="+this.x+", y="+this.y+")"},r.getAngle=function(){return t.radian2angle(Math.atan2(this.y,this.x))},r.toEgret=function(){return new egret.Point(this.x,this.y)},e.to=function(e){return t.Vector2D.create(e.x,e.y)},e}();t.Vector2D=e,egret.registerClass(e,"rm.Vector2D")}(rm||(rm={}));var rm;!function(t){t.version="1.1.7"}(rm||(rm={}));
var sm;!function(t){var e=function(){function t(){}var e=(__define,t);e.prototype;return t.e1="重复添加状态",t.e2="重复添加事件",t.e3="不可执行事件",t.e4="转向状态to不可以为none",t.e5="注册状态或事件不能为null",t.e6="注册状态必须有stateName或事件必须有eventName属性",t.e7="必须是函数",t.e8="当前已阻塞，等待调用transition或cancelTransition",t}();t.ErrorCode=e,egret.registerClass(e,"sm.ErrorCode")}(sm||(sm={}));var sm;!function(t){var e=function(){function e(){this.froms=[]}var n=(__define,e),r=n.prototype;return e.register=function(e,n,r){var i=new t.StateEventUnit;return i.register(e,n,r),i},r.addFroms=function(t){t&&0!=t.length&&t.forEach(function(t){this.addFrom(t)},this)},r.addFrom=function(t){t&&(t instanceof Array?this.addFroms(t):!this.findFromByName(t)&&this.froms.push(t))},r.findFromByName=function(t){var e=this.froms.indexOf(t);return!!~e},r.register=function(t,e,n){this.event=t,this.addFrom(e),this.to=n},e}();t.StateEventUnit=e,egret.registerClass(e,"sm.StateEventUnit")}(sm||(sm={}));var sm;!function(t){var e=function(){function e(){this.DEFAULT="none",this.ASYNC="async",this.initial=this.DEFAULT,this._data=new t.StateMachineData}var n=__define,r=e,i=r.prototype;return e.create=function(){return new t.StateMachine},n(i,"current",function(){return this._current||this.initial}),i.register=function(e,n,r){if(r==this.DEFAULT)throw t.ErrorCode.e4;var i=this._data.findStateEventUnitByToName(e,r);i?i.addFrom(n):(i=t.StateEventUnit.register(e,n,r),this._data.pushUnit(i))},i.registerStates=function(t){if(t){if(t instanceof Array)for(var e=t.length,n=0;e>n;n++)this.registerState(t[n]);else this.registerState(t);return this}},i.registerState=function(e){if(!e)throw t.ErrorCode.e5;if(!e.stateName)throw t.ErrorCode.e6;if(e.onEnter&&"function"!=typeof e.onEnter)throw"onAfter"+t.ErrorCode.e7;if(e.onLeave&&"function"!=typeof e.onLeave)throw"onLeave"+t.ErrorCode.e7;if(e.onInterrupt&&"function"!=typeof e.onInterrupt)throw"onInterrupt"+t.ErrorCode.e7;var n=this._data.findStateByName(e.stateName);if(n)throw t.ErrorCode.e1+e.stateName;this._data.pushState(e)},i.registerEvents=function(t){if(t){if(t instanceof Array)for(var e=t.length,n=0;e>n;n++)this.registerEvent(t[n]);else this.registerEvent(t);return this}},i.registerEvent=function(e){if(!e)throw t.ErrorCode.e5;if(!e.eventName)throw t.ErrorCode.e6;if(e.onAfter&&"function"!=typeof e.onAfter)throw"onAfter"+t.ErrorCode.e7;if(e.onBefore&&"function"!=typeof e.onBefore)throw"onBefore"+t.ErrorCode.e7;var n=this._data.findEventByName(e.eventName);if(n)throw t.ErrorCode.e2+e.eventName;return this._data.pushEvent(e),this},i.emit=function(e){if(this.transitionUnit)return void console.log(this.current,t.ErrorCode.e8,t.ErrorCode.e3,e);var n=this._data.findStateEventUnitByFromName(e,this.current);n&&this.execute(n),!n&&console.log(t.ErrorCode.e3,e)},i.can=function(t){if(this.transitionUnit)return!1;var e=this._data.findStateEventUnitByFromName(t,this.current);return!!e},i.is=function(t){return t==this.current},i.transition=function(){this.transitionUnit&&(this.interrupter(this.current),this.enter(this.transitionUnit.to),this.after(this.transitionUnit.event),this._current=this.transitionUnit.to),this.transitionUnit=null},i.cancelTransition=function(){this.transitionUnit&&(this.interrupter(this.current),this.after(this.transitionUnit.event)),this.transitionUnit=null},i.isTransition=function(){return!!this.transitionUnit},i.interrupt=function(){this.cancelTransition(),this._current=this.DEFAULT},i.execute=function(t){var e=this._data.findStateByName(this.current);this.before(t.event);var n=!0;e&&e.onLeave&&(n=e.onLeave()),n==this.ASYNC?this.transitionUnit=t:(this.enter(t.to),this.after(t.event),this._current=t.to)},i.interrupter=function(t){var e=this._data.findStateByName(t);e&&e.onInterrupt&&e.onInterrupt()},i.enter=function(t){var e=this._data.findStateByName(t);e&&e.onEnter&&e.onEnter()},i.after=function(t){var e=this._data.findEventByName(t);e&&e.onAfter&&e.onAfter()},i.before=function(t){var e=this._data.findEventByName(t);e&&e.onBefore&&e.onBefore()},e}();t.StateMachine=e,egret.registerClass(e,"sm.StateMachine")}(sm||(sm={}));var sm;!function(t){var e=function(){function t(){this._stateEventUnit=[],this._states={},this._events={}}var e=(__define,t),n=e.prototype;return n.pushUnit=function(t){var e=this.findStateEventUnitByToName(t.event,t.to);!e&&this._stateEventUnit.push(t)},n.pushState=function(t){var e=this.findStateByName(t.stateName);!e&&(this._states[t.stateName]=t)},n.pushEvent=function(t){var e=this.findEventByName(t.eventName);!e&&(this._events[t.eventName]=t)},n.findStateEventUnitByToName=function(t,e){for(var n=this._stateEventUnit.length,r=0;n>r;r++){var i=this._stateEventUnit[r];if(i.event==t&&i.to==e)return i}return null},n.findStateEventUnitByFromName=function(t,e){for(var n=this._stateEventUnit.length,r=0;n>r;r++){var i=this._stateEventUnit[r];if(i.event==t&&(this.isNoneEvent(i,e)||i.findFromByName(e)))return i}return null},n.isNoneEvent=function(t,e){return"none"==e?!0:t.findFromByName("none")},n.findStateByName=function(t){var e=this._states[t];return e||null},n.findEventByName=function(t){var e=this._events[t];return e||null},t}();t.StateMachineData=e,egret.registerClass(e,"sm.StateMachineData")}(sm||(sm={}));var sm;!function(t){t.version="1.0.3"}(sm||(sm={}));